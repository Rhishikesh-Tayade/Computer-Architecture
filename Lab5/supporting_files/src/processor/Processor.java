...
public class Processor {
	...
	public void printState(int memoryStartingAddress, int memoryEndingAddress) {
		System.out.println("Number of Cycles: " + generic.Statistics.numberOfCycles);
		System.out.println("Number of OF Stalls: " + generic.Statistics.numberOfStalls);
		System.out
				.println("Number of Wrong Branch Instructions: " + generic.Statistics.numberOfWrongBranchInstructions);
		System.out.println("Number of Data Hazards: " + generic.Statistics.numberOfDataHazards);
		System.out.println("Number of Control Hazards: " + generic.Statistics.numberOfControlHazards);
