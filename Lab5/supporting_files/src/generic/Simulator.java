...
public class Simulator {
	...
	static EventQueue eventQueue; // DES event queue
	...
	public static void simulate() {
		while (simulationComplete == false) {
			...
			eventQueue.processEvents(); // fire all events scheduled for this cycle
		...
		// Compute throughput: instructions per cycle
		if (Statistics.numberOfCycles > 0) {
			Statistics.throughput = (double) Statistics.numberOfInstructions / Statistics.numberOfCycles;
		}
	}
